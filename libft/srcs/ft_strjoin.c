...
/*   Updated: 2017/02/20 11:24:13 by jjourdai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*ft_strjoin(char const *s1, char const *s2)
{
	...
	new = (char*)malloc(sizeof(char) * (ft_strlen(s2) + ft_strlen(s1) + 1));
	if (new == NULL)
		return (NULL);
	ft_strcpy(new, s1);
	ft_strcat(new, s2);
...
char		*ft_strjoin_size(char *s1, char *s2, int len_s1, int len_s2)
{
	...
	i = -1;
	str = malloc(sizeof(char) * (len_s2 + len_s1 + 1));
	str_init = str;
	if (s1)
	{
...
char		*ft_strnjoin(char const *s1, char const *s2, size_t size)
{
	...
	if (!s1 || !s2)
		return (NULL);
	new = (char*)malloc(sizeof(char) * (ft_strlen(s1) + 1 + size));
	if (new == NULL)
		return (NULL);
	ft_strcpy(new, s1);
